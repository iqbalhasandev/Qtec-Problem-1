            ...
            <div class="card border-0">
                <div class="card-body table-responsive">
                    <div class="d-flex justify-context-between pb-2" style="justify-content: space-between;">
                        <a href="{{ route('search-activity.index') }}" class="btn btn-secondary rounded-0">Search
                            Activities</a>
                        <form action="{{ route('post') }}" class="search_form" style="max-width: 320px;">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="input-group-text bg-secondary text-white border-secondary rounded-0"
                                        style="border: 1px solid;">Search</button>
                                </div>
                            </div>
                        </form>
                    </div>
